                ...
                <div class="row">
                    ...
                    <div class="col col-7">
                        ...
                        <?php if( ( !empty($photo) ) ): ?>
                            ...
                            <img class="b-lazy img-person" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="<?php echo $photo['url']; ?>" alt="<?php echo $photo['alt']; ?>">
